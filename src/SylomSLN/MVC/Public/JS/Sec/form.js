(() => {
    ...
    (() => {
        ...
        (() => {
            ...
            function initRol(cb) {
                app.o.pjson('/seguridad/rol/readone', { idRol: getRolId() }, json => {
                    if (json) {
                        if (json.result) {
                            desc.value = json.result.nombre;
                            json.result.apartados.forEach(o => {
                                rolApartados.push({
                                    idApartado: o.idApartado,
                                    nombreApartado: o.nombre,
                                    create: o.create,
                                    read: o.read,
                                    update: o.update,
                                    del: o.del
                            ...
                            fillApartados();
                            json.result.usuarios.forEach(o => {
                                rolUsuarios.push({
                                    nombre: o.nombre,
                                    idUsuario: o.idUsuario
                                });
                            });
                            console.log(rolApartados, rolUsuarios);
                            fillUsuarios();
                            cb(true);
                        } else {
                            cb(false);
